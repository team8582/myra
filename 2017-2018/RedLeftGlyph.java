...
@Autonomous(name = "RedLeftGlyph", group = "Autonomous")
//@Disabled
public class RedLeftGlyph extends LinearOpMode {
    ...
    final double UP_JEWELS = 0.9;     //release servo open position
    final double DOWN_JEWELS = 0.0;   //release servo closed position
