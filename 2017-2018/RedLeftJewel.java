...
@Autonomous(name = "RedLeftJewel", group = "Autonomous")
//@Disabled
public class RedLeftJewel extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.jewels.setPosition(DOWN_JEWELS); //lowers servo arm
        sleep(2000);
        ...
        if (isRed) { //conditional statement for if the jewel to the left of the arm is red
            turnAbsolute(-10); //turn just enough to knock off blue jewel to left of arm
            sleep(1000);
            robot.jewels.setPosition(UP_JEWELS); //raise servo arm so as not to knock other jewel
            turnAbsolute(0); //return to initial position
            strafeUsingLeft(39); //strafe until parked in cryptobox zone
        } else if (isBlue) {
            strafeUsingLeft(39); //stafe until parked in cryptobox zone
